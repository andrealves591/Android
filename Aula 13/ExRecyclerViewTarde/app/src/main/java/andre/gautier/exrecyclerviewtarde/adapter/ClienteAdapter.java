package andre.gautier.exrecyclerviewtarde.adapter;
...
import andre.gautier.exrecyclerviewtarde.R;
...
public class ClienteAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        h.tvRenda.setText("Renda: " + String.valueOf(c.getNome()));
        h.tvFGTS.setText("FGTS: " + String.valueOf(c.calcularFGTS()));
    }
